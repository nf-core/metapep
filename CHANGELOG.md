...
- [#55](https://github.com/nf-core/metapep/pull/55) - Updated `PREDICT_EPITOPES` to use latest epytope version (3.3.0) and adjusted the scirpt `predict_epitopes.py` accordingly. Exchanged the container to official epytope container.
