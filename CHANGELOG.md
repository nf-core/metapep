...
- [#46](https://github.com/nf-core/metapep/pull/46) - Input type `taxa` changed from txt/tsv to csv only and increase format checks to ensure passing of optional `abundance` column
