...
- [MHCflurry](https://pubmed.ncbi.nlm.nih.gov/29960884/) and [MCHnuggets](https://pubmed.ncbi.nlm.nih.gov/31871119/): The score is based on a affinity scoring giving raise to scores with the unit `nmol/L` and representing an IC<sub>50</sub>. The downstream process `prepare_entity_binding_ratios` predicts binders using a threshold of ≤500 nmol/L.
