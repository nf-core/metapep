...
workflow METAPEP {
    ...
    if (params.supported_allele_information) {
        EPYTOPE_SHOW_SUPPORTED_MODELS (Channel.fromPath("${baseDir}/assets/external_software_versions.csv"))
        ...
        */
        ...
        methods_description    = WorkflowMetapep.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description)
