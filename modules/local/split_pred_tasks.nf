process SPLIT_PRED_TASKS {
  ...
  path "alleles_used.txt", emit: ch_alleles_for_chunks //this is the format required for PREPARE_PREDICTION_INPUT (a list of alleles)
  ...
  # take alleles from input samplesheet
  cp "$alleles" alleles_used.txt
