...
class Arguments:
    ...
    def __init__(self) -> None:
        ...
        self.tools = "$params.pred_method".split(',')      # Parameter changed for metapep compatibility
        self.min_peptide_length_classI = int("$params.min_pep_len")   # Parameter changed for metapep compatibility
        self.max_peptide_length_classI = int("$params.max_pep_len")   # Parameter changed for metapep compatibility
        self.min_peptide_length_classII = int("$params.min_pep_len")  # Parameter changed for metapep compatibility
        self.max_peptide_length_classII = int("$params.max_pep_len")  # Parameter changed for metapep compatibility
